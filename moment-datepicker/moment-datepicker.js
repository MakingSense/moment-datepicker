...
!function (window, undefined) {
  ...
  var momentDatepicker = function ($, moment, undefined) {

    // Picker object

    var Datepicker = function (element, options) {
      this.element = $(element);
      this.autoHide = options.autoHide !== false && this.element.data('datepicker-autohide') !== false;
    ...
    Datepicker.prototype = {
      ...
      fillMonths: function () {
        var html = '',
          i = 0,
          monthsShort = $.proxy(moment.langData().monthsShort, moment.langData());
    ...
    $.fn.datepicker = function (option, val) {
      ...
      var chain = this.each(function () {
        ...
        if (typeof option === 'string') {
          ...
          $this.data('datepicker', new Datepicker(this, $.extend({}, $.fn.datepicker.defaults, options)));
        }
      });
